...
minetest.register_node("epic:lightning", {
	...
	on_receive_fields = function(pos, _, fields, sender)
		...
		if fields.setpos then
			epic.chat_send_player(sender:get_player_name(), "Please punch the desired position")
...
minetest.register_on_punchnode(function(pos, _, puncher)
	...
	if cfg_pos then
		if minetest.is_protected(pos, playername) and
			...
			epic.chat_send_player(playername, "target for lightning successfully set to " .. pos_str)
